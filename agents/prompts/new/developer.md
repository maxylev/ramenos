...
5. **Timeliness & Fearless Web Research (CRITICAL):** Do NOT rely on your internal knowledge base for library syntax, SDKs, or market trends. You must actively and fearlessly use `searchfetch` (web search, web fetch), and `context7` to:
